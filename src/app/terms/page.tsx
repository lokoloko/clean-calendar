      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              By accessing and using CleanSweep ("Service"), you agree to be bound by these Terms of Service. 
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-muted-foreground">
              CleanSweep provides automated cleaning schedule management for short-term rental properties. Our services include:
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Your use of our Service is also governed by our Privacy Policy. By using CleanSweep, 
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              All content, features, and functionality of CleanSweep are owned by us and are protected by 
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              CleanSweep is provided "as is" without warranties of any kind. We are not liable for any 
        ...
        <div className="text-center pt-8 pb-4">
          <p className="text-sm text-muted-foreground">
            By using CleanSweep, you acknowledge that you have read and agree to these Terms of Service.
          </p>
        </div>
      </div>
    </AppLayout>
