-- =====================================================
-- CRITICAL SECURITY & SUBSCRIPTION MIGRATION (FINAL)
-- This version adds columns one by one for compatibility
-- =====================================================
...
-- =====================================================
-- 2. ADD SUBSCRIPTION FIELDS TO PROFILES (One at a time)
-- =====================================================
-- Add subscription_tier
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS subscription_tier VARCHAR(20) DEFAULT 'starter';
...
-- Check subscription fields were added:
SELECT 
    column_name,
    data_type,
    column_default
